...
import { getAxelPage } from "../../lib/contentful/pages/tour";
      ...
      <SinglePage coverImage={coverImage} objectPosition="top">
        <div className="container-md p-4 sm:p-8 bg-white">
          ...
          <div className="mt-16 max-w-[750px] mx-auto">
            <iframe
              data-tally-src="https://tally.so/embed/wkGyZj?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
              width="100%"
              height="300"
